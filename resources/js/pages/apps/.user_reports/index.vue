...
const fetchUsersForDownloadReports = (currentPage, rowPerPage) => {
  ...
  userListStore.fetchUsersForDownloadReports(pageQueryParam, rowPerPage, params)
    .then(response => {
...
const download_users_report = () => {
  ...
  axios.get('/api/web/download-all-users-report',{params})
    .then(response => {
            ...
            <tbody>
              <tr v-for="(user, index) in users" :key="user.id">
                ...
                <td class="text-capitalize text-high-emphasis">
                 ...
                 <span class="text-base">{{ user.emp_id ? user.emp_id : `TEMP/${user.id}` }}</span>
               </td>
...
<!-- 👉 ADADHAR VERIFICATION -->
                ...
                <td class="text-center">
                  ...
                  <!-- <span class="text-center text-high-emphasis">{{ user.created_at.substring(0, 10) }}</span> -->
                </td>
              </tr>
            </tbody>
