...
<template>
  <VRow>
    ...
    <VCol cols="12">
      <VCard title="Payment Methods">
        <template #append>
          <VBtn prepend-icon="bx-plus" @click="isCardAddDialogVisible = !isCardAddDialogVisible">
            Add Card
          </VBtn>
        </template>
            ...
            <VCardText class="d-flex flex-sm-row flex-column pa-5">
              <div class="text-no-wrap">
                ...
                <h4 class="text-base my-3">
                  {{ card.name }}
                  <VChip v-if="card.isPrimary" label color="primary" density="compact" class="ms-4">
                    Primary
                  </VChip>
                </h4>
              ...
              <div class="d-flex flex-column text-sm-end">
                <div class="order-sm-0 order-1">
                  <VBtn variant="tonal" class="me-4" @click="openEditCardDialog(card)">
                    Edit
                  </VBtn>
  ...
  <!-- 👉 Edit Card Dialog -->
  <CardAddEditDialog v-model:isDialogVisible="isCardEditDialogVisible" :card-details="currentCardDetails"
    class="v-dialog-lg" />

  <!-- 👉 Add Card Dialog -->
  <CardAddEditDialog v-model:isDialogVisible="isCardAddDialogVisible" class="v-dialog-lg" />

  <!-- 👉 Edit Address dialog -->
  <AddEditAddressDialog v-model:isDialogVisible="isEditAddressDialogVisible" :billing-address="currentBillingAddress" />
